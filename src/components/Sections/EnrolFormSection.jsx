...
import EnrolConfirmation from "../Enrollments/EnrolConfirmation.jsx";
// import EnrolForm from "../Enrollments/EnrolForm.jsx";
                ...
                <section className="lg:flex lg:space-x-[64px] space-y-[32px] lg:space-y-0">
                    ...
                    <motion.section
                        ...
                        <EnrolConfirmation
                            ...
                            email={values.email}
                            grade={values.grade}
                            subjectChoice={values.subjectChoice}
                        />
                        {showSuccess ?
                            <EnrolConfirmation
                                name={values.name}
                                ...
                                <form className="flex flex-col py-3 space-y-4" onSubmit={handleSubmit}>
                                    ...
                                    <div className="w-full flex justify-end">
                                        <button
                                            ...
                                            className="px-[32px] py-[8px] bg-secondary rounded-xl border-2 border-primary/40 font-bold w-full lg:w-auto disabled:bg-gray-200 ease-in-out"
                                        >
...
export default SectionsWrapper(EnrolFormSection, "enroll-form");
